...
/**
 * GIR 국가고유 배출계수 · 2017년 개정본 (이전 판, xlsm 참조 추정)
 * 온실가스종합정보센터.
 *
 * xlsm 이 참조한 것으로 추정되는 이전 판. 원본 xlsm 값이 K-ETS 별표 12 (2025)
 * · GIR 2022.1 공표 어느 것과도 일치하지 않는 4개 연료 (등유·경유·항공유·도시가스LNG)
 * 의 근거가 이 판 (또는 그 이전 판) 이라고 추정만 되고 정확한 원문은 재확보 필요.
 */
export const GIR_EF_2017: PrimarySource = {
  kind: "gir",
  docId: "gir-ef-2017",
  doc: "국가 고유 배출계수 (2017년 이전 공표 판, 추정)",
  publisher: "온실가스종합정보센터 (GIR)",
  edition: "2017 개정 추정",
  url: "https://www.gir.go.kr/home/index.do?menuId=36",
  maturity: "asserted",
  reviewedAt: "2026-09-02",
  note: "xlsm 이 참조한 것으로 추정되는 GIR 이전 판. GIR 국가고유 T2 배출계수 최신은 2022.1 공표 (GIR_EF_2022 참조)이며 K-ETS 지침 별표 12 (2025-04-11 개정) 는 이 값들을 대부분 반영. 별표 12 · GIR 2022.1 어느 것과도 일치하지 않는 4개 값 (등유·경유·항공유·도시가스LNG) 은 이 판을 임시로 참조하고 있으나 실제 원문 재확보 필요. 등유·항공유 는 원본 xlsm 저자가 별표 12 값을 뒤바꿔 넣은 오작성으로 판명, 경유·도시가스LNG 는 최신 공표와 소수점 3자리 수준 차이로 이전 판 참조 가능성.",
};
