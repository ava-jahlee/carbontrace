...
| 배출계수 T2 (등유·경유·항공유·도시가스LNG) | GIR 별도 공표계수 (별표 12 값과 불일치 · 원출처 재확인 예정) | asserted (별표 12 와 값 불일치 4건) |
...
- ✅ 2026-09-02 · K-ETS 별표 12 T2 국가고유 배출계수 42개 값 — 표 B (21개 연료 × tC + CO2) 매핑
   ...
   - **원본 xlsm 오작성 의심**: xlsm 등유 tC(19.931)와 항공유 tC(19.969)가 별표 12 등유(19,969)/항공유(19,931)와 정확히 뒤바뀌어 있음 → 원본 xlsm 저자 실수 가능성 · 향후 GIR 최신 공표계수와 재대조 예정
